...
#+begin_src bash
  ...
  # Compiling for Wayland? Use --with-pgtk too:
  ./configure --with-cairo --with-xwidgets --with-native-compilation --with-json
...
#+BEGIN_SRC emacs-lisp
    ...
    (defvar myemacs-theme 'spacemacs-light ;'rebecca
...
#+begin_src emacs-lisp
  (defun add-newline-end-of-buffer ()
    "Keeps the current position but adds a newline to the end of the buffer."
    (interactive)
    (save-excursion
      (goto-char (point-max))
      (insert "\n")))
  (defun my-whitespace-cleanup ()
    "Same as emacs' `whitespace-cleanup` but leaves a newline at the end of the file."
    (interactive)
    (whitespace-cleanup)
    (add-newline-end-of-buffer))
  ...
  (key-chord-define-global "ç "  'my-whitespace-cleanup)
